<div align="center">
  ...
  **A clean, lightweight, and responsive web application for managing daily tasks.**
...
*   **HTML5:** Semantic structure and page markup (`index.html`)[cite: 3].
*   **CSS3:** Custom styling and responsive design layout (`style.css`)[cite: 3].
*   **Vanilla JavaScript:** Dynamic DOM manipulation and application logic (`script.js`)[cite: 3].
